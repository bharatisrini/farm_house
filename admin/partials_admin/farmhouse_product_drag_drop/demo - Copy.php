    ...
    <div class="container">
        ...
        <div class="content-area">
    		...
    		<div class="content drag-desired">
				...
				//echo "  divya Product name".$dname;

				$result = mysqli_query($conn,"SELECT * FROM farmhouse_juice_details where product_type = 'juice' order by product_id");
