	 ...
	 $sql_detox1 = "select * from farmhouse_detox_program where countrylang_id = '$lid'";
        ...
        <div class="detox-box group">
            ...
            <aside class="product-details">
				...
				<?php $sql_detoxA = "select * from farmhouse_detox_program where detox_id ='$detox' and countrylang_id = '$lid'";
...
<div class="detox-box group">
            ...
            <div class="clear"></div>
            <p class="text-center">Make your own Detox by Selecting your own Juices.</p>
            <p>&nbsp;</p>
            <div class="clear"></div>
