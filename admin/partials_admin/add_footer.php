...
echo $langid;
  ...
  $sql = "INSERT INTO farmhouse_footer (heading, placeholder,button_name,carrers,carrers_link,contactus,contactus_link,copyright,countrylang_id)
  values('$heading', '$placeholder','$button_name','$carrers','$carrers_link','$contactus','$contactus_link','$copyright','$langid')";
    ...
    <div class="container">
         ...
         <div class="row  pad-top">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>  <h4>Add Footer</h4></strong>  
                            </div>
...
<br/>
								...
								<span class="input-group-addon"><label>Language</label></span>
									...
									<?php } ?>
										...
										<?php
										$sql_get = "select * from  farmhouse_footer";  
										$res_get = mysqli_query($conn,$sql_get);
										$row_get = mysqli_fetch_assoc($res_get);
										?>
                                         <div class="form-group input-group">
                                            <span class="input-group-addon">Heading </span>
											<span class="input-group-addon1"><?php echo $row_get['heading']; ?> </span>
                                            <input type="text" name= "heading" id  = "heading" class="form-control" maxlength="50" placeholder="Heading" />
										</div>
										<div class="form-group input-group">
											<span class="input-group-addon">Placeholder </span>
												<span class="input-group-addon1"><?php echo $row_get['placeholder']; ?> </span>
										...
										<div class="form-group input-group">
											<span class="input-group-addon">Button Name </span>
												<span class="input-group-addon1"><?php echo $row_get['button_name']; ?> </span>
										...
										<div class="form-group input-group">
                                            <span class="input-group-addon">Carrers </span>
												<span class="input-group-addon1"><?php echo $row_get['carrers']; ?> </span>
										...
										<div class="form-group input-group">
											<span class="input-group-addon">Carrers Link </span>
												<span class="input-group-addon1"><?php echo $row_get['carrers_link']; ?> </span>
										...
										<div class="form-group input-group">
											<span class="input-group-addon">Contactus </span>
												<span class="input-group-addon1"><?php echo $row_get['contactus']; ?> </span>
										...
										<div class="form-group input-group">
                                            <span class="input-group-addon">Contactus Link </span>
												<span class="input-group-addon1"><?php echo $row_get['contactus_link']; ?> </span>
										...
										<div class="form-group input-group">
											<span class="input-group-addon">Copyright </span>
												<span class="input-group-addon1"><?php echo $row_get['copyright']; ?> </span>
