...
$m=$n-1;
	...
	<div class="row group" >
				...
				if($select_box==''){ if($i==2) { $classimg="col-".$i." can-chedule"; $imgDefault="<img src='address_icons/1.png' id='df".(($i+$m)-1)."'>"; } else { $classimg="col-".$i; $imgDefault="";} }elseif($select_box=='A'){  if($i==2 || $i==5 || $i==7) { $classimg="col-".$i." can-chedule"; $imgDefault="<img src='address_icons/1.png' id='df".(($i+$m)-1)."'>";  $drpdrop="ondrop='drop(event,".(($i+$m)-1).")' ondragover='allowDrop(event)'";				
 
				} else { $classimg="col-".$i; $imgDefault=""; $drpdrop="";} }elseif($select_box=='B'){
				if($i==2 || $i==4 || $i==6) { $classimg="col-".$i." can-chedule"; $imgDefault="<img src='address_icons/1.png' id='df".(($i+$m)-1)."'>"; 
		$drpdrop="ondrop='drop(event,".(($i+$m)-1).")' ondragover='allowDrop(event)'";			
 } else { $classimg="col-".$i; $imgDefault=""; $drpdrop=""; }
				}elseif($select_box=='C'){ if($i==2 || $i==6 || $i==8) { $classimg="col-".$i." can-chedule"; $imgDefault="<img src='address_icons/1.png' id='df".(($i+$m)-1)."'>";$drpdrop="ondrop='drop(event,".(($i+$m)-1).")' ondragover='allowDrop(event)'";	
 } else { $classimg="col-".$i; $imgDefault="";  $drpdrop="";}
				}
				?>
				
                <div class="<?=$classimg?>" id="c<?=($i+$m)-1?>" style="color: #000000; font-size:xx-medium;" <?=$drpdrop?>><?=$imgDefault?><input name="sdate[]" id="sdate<?=($i+$m)-1?>" type="hidden" size="8"> <input name="saddr[]" id="saddr<?=($i+$m)-1?>" value='<?=$custAddressId?>' type="hidden" size="8"></div>
				<?php } ?>
			</div>
			<?php } ?>
...
<section class="center-link group">
	<div class="wrapper group">
    	...
    	<a  class="add-card" id="submitData">Add Into</a>
    </div>
</section>
