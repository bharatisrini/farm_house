...
//alert(id);
			...
			if(html.toString().match("your item has already been added into cart")){ $("#checkOut"+id).html("<font color='red'>Already Added<font color='red'>").delay(1000).fadeOut();}else{
			$("#checkOut"+id).html("<font color='green'> Added to Cart</font>").delay(1000).fadeOut();
			//				var urls="jucie.php";
			//alert(urls);
...
<section class="slider fixed-top group">
	<div class="wrapper group">
    	<div class="center-slider-jucie">
			<?php
				$sql = "select image2 from farmhouse_juice_details where image2 != '' order by product_id";
...
<section class="juices-list group">
	<div class="wrapper group">
		...
		<?php
			$sql_pro = "select * from farmhouse_juice_details order by product_id ASC";
