...
//echo $name;
   $sql_d_id = "select * from farmhouse_detox_program where detox_name ='$product'";
   $res_id = mysqli_query($conn,$sql_d_id);
   $row_id = mysqli_fetch_array($res_id);
   $detoxitem_id = $row_id['detox_item_id'];
   
  $sql = "INSERT INTO farmhouse_detox_program (detox_id,detox_name,detox_items,detox_price,title_1,discription_1,ip,date_added,countrylang_id,detox_item_id) 
  values('$detox_id','$dname','$ditems','$price','$t_1','$d_1','$ip','$date_added','$langid','$detoxitem_id')";
    ...
    <div class="container">
         ...
         <div class="row  pad-top">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>  <h4> Convert detox to Other Languages </h4></strong>  
                            </div>
...
<br/>								
								...
								<span class="input-group-addon"><label>Language</label></span>
									...
									<?php } ?>
										...
										<div class="form-group input-group">
								<span class="input-group-addon"><label>Detox Name</label></span>
									
									<select  name="product" id="product">
										<option value="">Select Detox Name</option>
										<?php
										$sql_go = "select * from  farmhouse_detox_program where countrylang_id = '1'";  
										$res_go = mysqli_query($conn,$sql_go);
										while($row_go = mysqli_fetch_array($res_go)) {

										?>
										<option value="<?php echo $row_go['detox_name']; ?>"><?php echo $row_go['detox_name']; ?></option>
									<?php } ?>
									</select>
                                        ...
                                        <div class="form-group input-group">
										 ...
										 <div class="form-group input-group">
											...
											<input type="text" name= "dname" id  = "dname" class="form-control" required="" value="<?php ?>"  placeholder="Detox Name" maxlength="50"  />
                                        </div>
										
										 <div class="form-group input-group">
                                            <span class="input-group-addon">Detox Items</span>
