...
function validate()
	...
	if (document.production_signup.fname.value == "!`@#$%^&*()+=[]\\\';,./{}|\":<>?~_")
          {
		alert('Name : Please Enter valid first name without special character');
		document.production_signup.fname.focus();
		return false;
          }
		  
	if (document.production_signup.lname.value == "!`@#$%^&*()+=[]\\\';,./{}|\":<>?~_")
          {
		alert('Name : Please Enter valid last name without special character');
		document.production_signup.lname.focus();
		return false;
          }
		  
	if (document.production_signup.image1.value== '')
          {
		alert('Image : Please Select an image for Juice');
		document.production_signup.image1.focus();
		return false;
          }	
