...
//echo $name;
  ...
  $sql = "INSERT INTO farmhouse_lifestyle_program (lifestyle_id,lifestyle_name,lifestyle_items,lifestyle_price,title_1,discription_1,ip,date_added) 
  values('$lifestyle_id','$dname','$ditems','$price','$t_1','$d_1','$ip','$date_added')";
  ...
  if(mysqli_query($conn,$sql))
				{
					...
					window.location='farmhouse_product_drag_drop/demo_lifestyle.php?dname=<?=$dname?>';
