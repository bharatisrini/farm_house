...
var dataPass;
 ...
 img=id+"<br>"+name;
  ...
  img="<br><div style='font-size:80px;'>"+id+"</div><br>"+name;
  }
...
<?php include("includes/header.php"); ?>
	 ...
	 $sql_detox1 = "select * from farmhouse_detox_program where countrylang_id='$lid'";
	// echo $sql_detox1;
...
//					 echo " Detox id " .$detox;
        ...
        <div class="detox-box group">
        	<aside class="basket">
            	<div class="basket-box">
                	<div class="basket-padding">
					    ...
					    <?php
					  $sql_detox = "select * from farmhouse_detox_program where detox_id ='$detox' and countrylang_id='$lid'";
				      $res_detox = mysqli_query($conn,$sql_detox);
					  $row_detox = mysqli_fetch_array($res_detox);
					   //echo "Y".$arr_detox[$i];
					   $arr_detox_id = explode(",",trim($row_detox['detox_item_id']));
					  $arr_detox = explode(",",trim($row_detox['detox_items']));
					
						 for ($i=1; $i<=6; $i++) {
						$k=$i-1;
					
						   $sql_juice = "select * from farmhouse_juice_details where product_id=' $arr_detox_id[$k]' and countrylang_id='$lid'";
						   //echo $sql_juice;
					  ...
					  $imgs2=$row_juice['image2'];
						 ...
						 <div class="product-popup group detox<?=$detlwc?>-<?php echo $i;?>">
                            	<div class="padding group">
                                    ...
                                    <div class="details">
                                    	<p class="title"><?php
										$sql = "select * from farmhouse_juice_details where product_id =  '$prd_id' and countrylang_id='$lid'";
                                        ...
                                        <ul><li>
                    						<?php
					  $sql_no_items = "select * from farmhouse_juice_details where product_id = '$prd_id' and countrylang_id='$lid'";
					  ...
					  ?>
                        	...
                        	<div style="font-size:80px;"><?=$row_no_items["product_id"]?></div><br>
                           <?=$arr_detox[$k]?>
                            </div>
                ...
                <div class="extra-bottle group">
					<div class="product-select-popup group add-bottle-<?=$detlwc?>">
						...
						<?php
						//echo "N".$prd_id;
						$sql_no_items_hyd = "select * from farmhouse_juice_details where product_type='hydration'  and countrylang_id='$lid'";
            ...
            <aside class="product-details">
				...
				<?php $sql_detoxA = "select detox_items,detox_price,detox_id from farmhouse_detox_program where detox_id ='$detox' and  countrylang_id='$lid'";
                        ...
                        <div class="circle-add">
                          ...
                          <div class="product-select-popup-add-custom group">
                            <div class="padding group">
								...
								$sqls = "select * from farmhouse_juice_details where product_type ='juice' and countrylang_id='$lid'";
