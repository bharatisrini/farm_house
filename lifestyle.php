...
<?php include("includes/header.php"); ?>
		 ...
		 <h2>FARMHOUSE LIFESTYLE</h2>
			<?php
	 $sql_detox1 = "select * from farmhouse_lifestyle_program where countrylang_id = '$lid'";
  ...
  while($row_detox1=mysqli_fetch_assoc( $res_detox1)){
        ...
        <div class="detox-box group">
        	<aside class="basket">
            	<div class="basket-box">
                	<div class="basket-padding">
					  ...
					  $sql_detox = "select * from farmhouse_lifestyle_program where lifestyle_id='$detox' and countrylang_id = '$lid'";
				      $res_detox = mysqli_query($conn,$sql_detox);
					  $row_detox = mysqli_fetch_array($res_detox);
					   //echo "Y".$row_detox['lifestyle_items_id'];
					     $arr_detox_id = explode(",",trim($row_detox['lifestyle_items_id']));
            ...
            <aside class="product-details">
				...
				<?php $sql_detoxA = "select * from farmhouse_lifestyle_program where lifestyle_id ='$detox' and countrylang_id = '$lid'";
            ...
            <div class="clear"></div>
            <p class="text-center"><?php echo $row['discription_1']; ?>.</p>
            <p>&nbsp;</p>
            <div class="clear"></div>
...
<div class="detox-box group">
            ...
            <div class="clear"></div>
            <p class="text-center">Make your own lifestyle, by selecting your own Choice of Juices .</p>
            <p>&nbsp;</p>
            <div class="clear"></div>
