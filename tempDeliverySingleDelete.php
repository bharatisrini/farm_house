...
//echo $sql_orders;
	  ...
	  $sql_order_delivery = "update farmhouse_temp_schedule_detox  set delivery_address='$tmp_oldaddr', address_id='$tmp_oldaddr', delivery_date='$tmp_dates' where customer_id='".$cu_id."' and detox_name='".$detox."' and trans_id='$tempTransId'";
...
if($tmp_oldaddr==""){
$sql_order_deliverys = "delete from farmhouse_temp_schedule_detox where customer_id='".$cu_id."' and detox_name='".$detox."' and trans_id='$tempTransId'";
