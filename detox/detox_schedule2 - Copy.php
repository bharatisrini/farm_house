	...
	<div class="wrapper">
        ...
        <div class="pick-plan group">
        	...
        	<div class="row-top group">
            	...
            	<div class="col-1">&nbsp;</div>
                <div class="col-2" id="2">Wed</div>
                <div class="col-3" id="3">Thu</div>
                <div class="col-4" id="4">Fri</div>
                <div class="col-5" id="5">Sat</div>
                <div class="col-6" id="6">Sun</div>
                <div class="col-7" id="7">Mon</div>
                <div class="col-8" id="8">Tue</div>
