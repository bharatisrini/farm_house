...
<head>
	...
	if (document.dispatch_signup.fname.value == "!`@#$%^&*()+=[]\\\';,./{}|\":<>?~_")
          {
		alert('Name : Please Enter valid first name without special character');
		document.dispatch_signup.fname.focus();
		return false;
          }
		  
	if (document.dispatch_signup.lname.value == "!`@#$%^&*()+=[]\\\';,./{}|\":<>?~_")
          {
		alert('Name : Please Enter valid last name without special character');
		document.dispatch_signup.lname.focus();
		return false;
          }
		  
	if (document.dispatch_signup.image1.value== '')
          {
		alert('Image : Please Select an image for Juice');
		document.dispatch_signup.image1.focus();
		return false;
          }	
...
<body>
<form method="POST" name='dispatch_signup' action = "<?php $PHP_SELF ?>" enctype="multipart/form-data" onsubmit = "return validate()">
 <div class="container">
...
<br/>
										...
										<div class="form-group input-group">
                                         ...
                                         <div class="form-group input-group">
                                            ...
                                            <input type="text" name="mobile" id="mobile" maxlength = "12" class="form-control" required="" placeholder="Mobile No" />
                                        </div>
                                      ...
                                      <div class="form-group input-group">
										    ...
										    <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-phone"  ></i></span>
                                            <textarea name="address" id="address" class="form-control" rows="4" required="" placeholder = "Address"></textarea>
                                        </div>
