    ...
    <div class="container">
		...
		$row_pro = mysqli_fetch_array($res_pro);
	     $pro_id = $row_pro['product_id'];
				$sql_query_in_prod = "insert into farmhouse_lifestyle_program_items(program_name,product_id,product_name)values('$dname','$pro_id','$arr_item[$j]')";
				...
				$d_id = $row_get_id['d_id'];
				      ...
				      $sql_up = "update farmhouse_lifestyle_program set lifestyle_items = '$a' , lifestyle_price='$total' where lifestyle_id = '$d_id'";
