...
$sql_lifestyle_tmps = "insert into farmhouse_user_detox_program(customer_id, detox_name, detox_price, detox_items, ip, date_added)  
 values ('$cid','$detox_name','$amt','$myitems','$ip','$current_date')";
echo $sql_lifestyle_tmps;
$res_transs=mysqli_query($conn,$sql_lifestyle_tmps);
 $dx_id = mysqli_insert_id($conn);
