...
<section class="plan">
	...
	//	 echo " Vasu Hide for the condition ";
	}
	else
	{
?>
        ...
        <div class="pick-plan group">
			...
			<!--loop start for no of people-->
			 ...
			 <div class="row group">
				...
				<?php 
				for($i = 2; $i<=8; $i++) { ?>
                <div class="<?php if($i==2 || $i==5 || $i==7) { echo "col-".$i." can-chedule"; } else { echo "col-".$i; } ?>" id="<?php echo "col-".$i;?>" style="color: #000000; font-size:xx-medium;"> </div> <?php } ?>
                <!--<div class="col-2 can-chedule" id="2"></div>
                <div class="col-3"></div>
...
<section class="next-button group">
	...
	window.location.href = "detox_schedule2.php?per_name="+x+"&date="+z+"&a1="+a1+"&a2="+a2+"&a3="+a3+"&tid="+t_id;
	} //ends if2
	if(x=="B" && z!="") {
