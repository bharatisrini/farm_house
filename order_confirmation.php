...
?>
	<tr>
	 ...
	 <?php if($row_order_detox['program_type']=='Retail'){?>
	 <td align="center"> <?php echo $row_order_detox['quantity_ordered'] ?></td>
	 <?php }else{?>
	  <td align="center"> <?php echo $row_order_detox['ordered_num_of_people']?> People <?php echo $row_order_detox['ordered_day_beauty']?> Day</td>
...
<br>
 ...
 <?php echo " <br><br><h3> Payment Details </h3><hr>"; 
	 ...
	 //echo  $sql_order_paymnt;
	 $res_order_paymnt = mysqli_query($conn,$sql_order_paymnt); 
	 $row_order_paymnt = mysqli_fetch_array($res_order_paymnt);
	 if($row_order_paymnt['payment_type']=="Pay on delivery"){
	  echo $row_order_paymnt['payment_type'];
...
<table width='60%'	border = 1 cellspacing="0" cellpadding="2">
   ...
   <tr>
	<td align="right"><?php echo $row_order_paymnt['payment_method']; ?>
	 </td>
...
<table>	
	...
	<tr>
     ...
     <td align="left"> <strong>Total Amount </td>
	 <td align="left">&nbsp;  </td>
