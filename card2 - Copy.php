...
path_img=banks[2];							   
var dataPass;
dataPass="msg=pay&p_typ="+p_typ+"&bank_name="+bank_name;
//alert(dataPass);
//alert(selectedDate);
url="add_to_cart.php"
$("#datError").html('Loading.....'); 
  $.ajax( {
						...
						success : function(html) {
							...
							//confirm
							var urls = "card3.php?bnkimg="+path_img+","+bnk_img;
					...
					xmlhttp.open("POST","add_to_cart.php?msg=pay&p_typ="+p_typ+"&bank_name="+bank_name,true);
					xmlhttp.send();*/
 ...
 <?php $sql2="SELECT sum(total_item_amount) as total FROM farmhouse_temp_cart_fh where customer_id = '$cid'";
        ...
        <div class="pay group">
        	<div class="pay-on group">
            	<p>
            	  <input type="radio" name="pay-on" class="round" id="p_d" value="Pay on delivery"/>
           	    <span>Pay on delivery</span></p>
            	<p><input type="radio" name="pay-on" class="round" id="p_o" value="Pay online" checked="checked"/> <span>Pay online</span></p>
          </div>
