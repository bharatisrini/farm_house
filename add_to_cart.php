...
$sql_add = "INSERT INTO farmhouse_temp_cart_fh(product_image_url, product_price, no_items, total_item_amount, ip, product_name, customer_id, product_id,order_name,address,date_added) values('$image_url','$product_price','$no_items','$total_item_amount','$ip','$product_name','$cu_id', '$product_id','','$address','$cdate')";
